...
It mimics the interface of agentconnect.core.registry.AgentRegistry, but uses HTTPX for asynchronous requests.
"""
...
#     # E.g., uvicorn agentconnect.servers.registry_api_server:app --reload --port 8000
