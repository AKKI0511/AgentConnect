...
PUBLIC_SCHEMA_TYPES: dict[str, Any] = {
    ...
    "NoReplyRequestMessage": NoReplyRequestMessage,
    "ReplyExpectedRequestMessage": ReplyExpectedRequestMessage,
    ...
    "NoReplySendRequest": NoReplySendRequest,
    "CollectedSendRequest": CollectedSendRequest,
