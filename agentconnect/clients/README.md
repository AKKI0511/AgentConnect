...
├── registry_client.py          # Registry API client implementation
└── README.md                   # This file
```
...
**Target:** `agentconnect/servers/registry_api_server.py`
...
**Target:** `agentconnect/core/registry/search/schemas.py`
...
- **Client:** `agentconnect/clients/registry_client.py` - Lines 278-403 (N+1 pattern)
- **Server:** `agentconnect/servers/registry_api_server.py` - Lines 257-296 (semantic search endpoint)
- **Schemas:** `agentconnect/core/registry/search/schemas.py` - AgentSearchResultItem definition
- **Utils:** `agentconnect/core/registry/search/utils.py` - populate_search_result_item function
