...
- Moved optional backends behind extras: `serve` (FastAPI, uvicorn, MCP), `mcp`, `redis`, `cli`, `aiagent`, `telegram`, `embeddings`, `index`, and `payments`. Embedded `pip install agentconnect` stays small.
