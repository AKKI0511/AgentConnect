    ...
    agent_profile = AgentProfile(
        ...
        skills=[
            Skill(
                ...
                description="Tracks conversation context across multiple threads",
            ),
            Skill(
                name="topic_switching",
                description="Switches between different conversation topics",
            ),
        ],
...
async def ai_agent_configuration_example():
    ...
    advanced_profile = AgentProfile(
        ...
        skills=[
            ...
            Skill(
                ...
                description="Explains technical concepts clearly",
            ),
        ],
    )
    ...
    advanced_agent = AIAgent(
        ...
        model_config={"temperature": 0.7, "top_p": 0.95, "max_tokens": 500},
