...
# Create module-level app (e.g., uvicorn agentconnect.index.service:app)
app = create_registry_api_app()


# Example: How to run this server (e.g., using uvicorn)
# uvicorn agentconnect.index.service:app --reload --port 8000
#
if __name__ == "__main__":
    import uvicorn

    # This allows running directly with `python -m agentconnect.index.service`
