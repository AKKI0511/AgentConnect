...
class ToolTracerCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(
        self,
        agent_id: str,
        print_tool_activity: bool = False,  # Default OFF
        print_reasoning_steps: bool = True,  # Default ON - Print LLM generation text
        print_llm_activity: bool = False,  # Default OFF
    ):
        """
        ...
        Args:
            ...
            print_reasoning_steps: If True, print the text generated by the LLM in on_llm_end.
                                    This often contains reasoning or thought processes.
            print_llm_activity: If True, print LLM start events to console.
        """
        super().__init__()
        self.agent_id = agent_id
        self.print_tool_activity = print_tool_activity
        self.print_reasoning_steps = print_reasoning_steps
        self.print_llm_activity = print_llm_activity
        ...
        init_msg = (
            ...
            f"LLM Start: {print_llm_activity})"
        )
        ...
        if self.print_tool_activity:
            ...
            if tool_name == "send_collaboration_request":
                ...
                if json_data and isinstance(json_data, dict):
                    ...
                    if success is True:
                        status = "completed successfully. Please make the payment."
                ...
                print_msg = f"{color}➡️ Collaboration request {status}{Style.RESET_ALL}"
